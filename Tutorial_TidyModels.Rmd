...
Below is a *workflow* for a decision tree with hyperparameter tuning.
...
These two pieces of information are aggregated with *workflow*:
```{r}
...
In summary, the best result for polynomial regression, according to cross-validation:
